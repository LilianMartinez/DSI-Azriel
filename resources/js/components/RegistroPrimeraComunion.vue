                    ...
                    <div class="card-body">
                        <div v-show="cambiarm==0 || cambiarm==6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" tabindexgt="0" v-model="alcaldia" class="form-control" placeholder="Nombre de alcaldía">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Libro<b class="alerta">*</b></label>
                                <div class="col-md-4">
                                    <input type="text" tabindexgt="0" v-model="libro" class="form-control" placeholder="Número de libro">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Partida<b class="alerta">*</b></label>
                                <div class="col-md-4">
                                    <input type="text" tabindexgt="0" v-model="partida" class="form-control" placeholder="Número de partida">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Folio<b class="alerta">*</b></label>
                                <div class="col-md-4">
                                    <input type="text" tabindexgt="0" v-model="folio" class="form-control" placeholder="Número de folio">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div v-show="cambiarm==3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                        <select class="form-control" v-model="nombresacerdote"> 
                                        <option value="0" disabled>Seleccione</option>
                                        <option v-for="sacerdote in arraysacerdote" :key="sacerdote.id"  v-bind:value="sacerdote.id" v-text="sacerdote.nombre_persona"></option>
                                        </select>
                                    </div>
                            </div>
                            <div class="form-group row">
