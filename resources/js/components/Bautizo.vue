<template>
   <main class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header"><label class="titulo-encabezados">Historial de bautizos</label>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="realizante in arrayrealizante" :key="realizante.id">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" class="btn btn-success btn-sm" @click="abrirModal2('bautizo','imprimir',realizante)">
      ...
      data(){
        ...
        methods:{
            ...
            listarPersona(page,nombre,apellido){
                ...
                var url='/persona/listarbautizos?page='+ page + '&nombre=' + nom +'&apellido='+ ape;
