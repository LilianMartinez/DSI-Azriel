                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="realizante in arrayrealizante" :key="realizante.id">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" class="btn btn-success btn-sm" @click="abrirModal2('primeracomunion','imprimir',realizante)">
      ...
      data(){
        ...
        methods:{
            ...
            listarPersona(page,nombre,apellido){
                ...
                var url='/persona/listarcomuniones?page='+ page + '&nombre=' + nom +'&apellido='+ ape;
                ...
                switch(modelo){
                    case "primeracomunion":
                    {
                        switch(accion){
                            case 'imprimir':{
                                this.modal4=1;
                                this.tituloModal = 'Imprimir acta de Primera Comunión';
