            ...
            <!-- tiululo -->
                <div class="card">
                    <div class="card-header">
                        <label class="titulo-encabezados">Registro de acta de confirmacion</label>
                    </div>
                    <!-- cuerpo -->
                    <div class="card-body">
                        ...
                        <div v-show="cambiarm==7">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" tabindexgt="0" v-model="libroc" class="form-control" placeholder="# de libro">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Folio</label>
                                <div class="col-md-5">
                                    <input type="text" tabindexgt="0" v-model="folioc" class="form-control" placeholder="# de folio">
                                </div>
                            </div>
                            <div class="form-group row">
